...
describe("urlToPagePathSegments", () => {
  test("maps root route to host + _index", () => {
    expect(urlToPagePathSegments("https://bengous.github.io/")).toEqual([
      "bengous.github.io",
      "_index",
    ]);
  });
...
describe("audit path helpers", () => {
  test("builds page and viewport directories", () => {
    ...
    expect(viewportDir).toBe(
      "/tmp/audit-20260220-1730/pages/example.com/fr/about/_index/desktop-1920x1080",
    );
  });
  ...
  test("uses device id in viewport directory when provided", () => {
    ...
    expect(viewportDir).toBe(
      "/tmp/audit-20260220-1730/pages/example.com/fr/about/_index/desktop-1920-1920x1080",
    );
  });
});
